import 'package:msrufaati/controllers/db_helper.dart';
import 'package:msrufaati/pages/add_transaction.dart';
import 'package:msrufaati/pages/models/transaction.dart';
import 'package:msrufaati/pages/settings.dart';
import 'package:msrufaati/pages/widgets/confirm_dialog.dart';
import 'package:msrufaati/pages/widgets/info_snackbar.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:msrufaati/static.dart' as Static;
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(
                            width: 200.0,
                            child: Text(
                              " مصروفاتي ${preferences.getString('name')}",
                              style: TextStyle(
                                fontSize: 24.0,
